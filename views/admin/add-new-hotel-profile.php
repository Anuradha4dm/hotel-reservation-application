...
<body>
    ...
    <div class="container  mb-5">
        <form class="form-group" action="/php/admin/add-new-profile.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <input type="hidden" name="hotelid" value="<?php print_r($_GET['hotelId'])  ?>">
